...
class Result(Page):
    ...
    def js_vars(self):
        ...
        return dict(url='https://survey.maximiles.com/complete?p=73954_59724ae7&m='+username_value)
...
class Timeout(Page):
    ...
    def js_vars(self):
        username_value = self.participant.label
        return dict(url='https://survey.maximiles.com/quality?p=73954&m='+username_value)
